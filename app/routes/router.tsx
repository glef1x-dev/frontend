...
const About = withSuspense(
  React.lazy(() => import("../features/about-me/components/About.js"))
);
const OpenSource = withSuspense(
  React.lazy(
    () => import("../features/opensource-projects/components/OpenSource.js")
  )
);
const Blog = withSuspense(
  React.lazy(
    () => import("../features/blog/components/BlogArticlePreviewList.js")
  )
);
