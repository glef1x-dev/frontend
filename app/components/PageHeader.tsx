...
const PageHeader: React.FC<PageHeaderProps> = function ({ title, description }: PageHeaderProps) {
  const theme = useTheme();
  const pageHeaderBackgroundColor = theme.palette.mode === 'light' ? '#f8f9fa' : 'rgb(18,18,18)';
  return (
    <header
      style={{
